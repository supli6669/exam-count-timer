...
- Tối ưu countdown: Exam Card dùng một nguồn thời gian chung thay vì tạo interval riêng cho từng môn; thêm `npm test` với ba test cốt lõi cho countdown, lịch flashcard và độ ưu tiên kế hoạch học.
